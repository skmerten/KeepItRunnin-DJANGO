...
class NewPart(forms.ModelForm):
    ...
    part_description = forms.CharField(label='Description', max_length=255, widget=forms.TextInput(attrs={'class':'input'}))
    ...
    comments = forms.CharField(label='Comments', max_length=255, widget=forms.TextInput(attrs={'class':'input'}))
    purchase_location = forms.CharField(label='Purchase Location', max_length=250, widget=forms.TextInput(attrs={'class':'input'}))
    purchase_price = forms.FloatField(label = "Purchase Price", widget=forms.NumberInput(attrs={'class':'input'}))
    date_of_purchase = forms.DateField(label='Date Of Purchase', widget=forms.DateInput(attrs={'class':'input'}))
    after_comments = forms.CharField(label='Purchase Comments', max_length=255, widget=forms.TextInput(attrs={'class':'input'}))
